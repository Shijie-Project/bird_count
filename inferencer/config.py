...
class SmartPlugConfig:
    ...
    device_maps: dict[str, str] = field(
        default_factory=lambda: {
            ...
            "192.168.0.198": [4, 5, 6],
            "192.168.0.102": [7, 8, 9],
            "192.168.0.195": [10, 11, 12],
            "192.168.0.130": [13, 14, 15],
            "192.168.0.164": [16, 17, 18],
            "192.168.0.110": [19, 20, 21],
        }
    )
...
class Config:
    ...
    source_type: SourceConfig = field(default_factory=SourceConfig)
    ...
    def __post_init__(self):
        raw_sources = self.source_type.get_raw_sources()
    ...
    def from_settings(cls, envs: Any) -> "Config":
        ...
        source_cfg = SourceConfig(mode=envs.source_type)

        return cls(hardware=hw_cfg, stream=stream_cfg, source_type=source_cfg)
